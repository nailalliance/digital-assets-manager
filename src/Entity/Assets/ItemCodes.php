...
#[ORM\Entity(repositoryClass: ItemCodesRepository::class)]
class ItemCodes
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
     ...
     */
    #[ORM\ManyToMany(targetEntity: Assets::class, mappedBy: 'itemCode')]
