 ...
 */
final class Version20250826193316 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE assets (id INT AUTO_INCREMENT NOT NULL, uploader_id INT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, file_path VARCHAR(255) NOT NULL, thumbnail_path VARCHAR(255) DEFAULT NULL, mime_type VARCHAR(255) NOT NULL, file_size INT NOT NULL, color_space VARCHAR(255) DEFAULT \'rgb\' NOT NULL, status VARCHAR(255) DEFAULT \'active\' NOT NULL, embargo_date DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', expiration_date DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', tus_upload_key VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_79D17D8E6EED9424 (tus_upload_key), INDEX IDX_79D17D8E16678C77 (uploader_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE item_codes (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_CF0ADA9D77153098 (code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE lists (id INT AUTO_INCREMENT NOT NULL, creator_id INT NOT NULL, name VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', status TINYINT(1) DEFAULT 1 NOT NULL, INDEX IDX_8269FA561220EA6 (creator_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE one_time_links (id INT AUTO_INCREMENT NOT NULL, download_list_id INT DEFAULT NULL, assets_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, token VARCHAR(255) NOT NULL, expiration_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', temporary_files JSON DEFAULT NULL, tus_upload_key VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_D32A8E1E6EED9424 (tus_upload_key), INDEX IDX_D32A8E1E91D0174E (download_list_id), INDEX IDX_D32A8E1EE6AF163A (assets_id), INDEX IDX_D32A8E1E61220EA6 (creator_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, roles JSON NOT NULL, name VARCHAR(120) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
